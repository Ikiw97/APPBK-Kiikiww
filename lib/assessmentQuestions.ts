...
// Jurusan untuk asesmen SMA/SMK
export interface JurusanCategory {
  id: string;
  name: string;
  type: 'SMA' | 'SMK';
  label: string;
...
export const SMA_SMK_JURUSAN: JurusanCategory[] = [
  // SMA
  { id: 'sma_ipa', name: 'IPA', type: 'SMA', label: 'SMA - IPA (Ilmu Pengetahuan Alam)' },
  { id: 'sma_ips', name: 'IPS', type: 'SMA', label: 'SMA - IPS (Ilmu Pengetahuan Sosial)' },
  { id: 'sma_bahasa', name: 'Bahasa', type: 'SMA', label: 'SMA - Bahasa dan Budaya' },
  // SMK
  { id: 'smk_teknologi', name: 'Teknologi & Rekayasa', type: 'SMK', label: 'SMK - Teknologi & Rekayasa' },
  { id: 'smk_tik', name: 'TIK', type: 'SMK', label: 'SMK - Teknologi Informasi & Komunikasi' },
  { id: 'smk_bisnis', name: 'Bisnis & Manajemen', type: 'SMK', label: 'SMK - Bisnis dan Manajemen' },
  { id: 'smk_kesehatan', name: 'Kesehatan', type: 'SMK', label: 'SMK - Kesehatan dan Pekerjaan Sosial' },
  { id: 'smk_pariwisata', name: 'Pariwisata', type: 'SMK', label: 'SMK - Pariwisata' },
  { id: 'smk_agribisnis', name: 'Agrobisnis', type: 'SMK', label: 'SMK - Agrobisnis & Agroteknologi' },
  { id: 'smk_seni', name: 'Seni & Kreatif', type: 'SMK', label: 'SMK - Seni dan Industri Kreatif' },
];
...
export const assessmentQuestions: Record<string, Question[]> = {
  ...
  sma_smk: Array.from({ length: 50 }, (_, i) => {
    // Jurusan mapping: 5 pertanyaan per jurusan
    const jurusanMap = [
      'sma_ipa', 'sma_ipa', 'sma_ipa', 'sma_ipa', 'sma_ipa',
      'sma_ips', 'sma_ips', 'sma_ips', 'sma_ips', 'sma_ips',
      'sma_bahasa', 'sma_bahasa', 'sma_bahasa', 'sma_bahasa', 'sma_bahasa',
      'smk_teknologi', 'smk_teknologi', 'smk_teknologi', 'smk_teknologi', 'smk_teknologi',
      'smk_tik', 'smk_tik', 'smk_tik', 'smk_tik', 'smk_tik',
      'smk_bisnis', 'smk_bisnis', 'smk_bisnis', 'smk_bisnis', 'smk_bisnis',
      'smk_kesehatan', 'smk_kesehatan', 'smk_kesehatan', 'smk_kesehatan', 'smk_kesehatan',
      'smk_pariwisata', 'smk_pariwisata', 'smk_pariwisata', 'smk_pariwisata', 'smk_pariwisata',
      'smk_agribisnis', 'smk_agribisnis', 'smk_agribisnis', 'smk_agribisnis', 'smk_agribisnis',
      'smk_seni', 'smk_seni', 'smk_seni', 'smk_seni', 'smk_seni'
    ];
    const jurusan = jurusanMap[i];
    const category = jurusan.startsWith('sma_') ? 'Minat Akademik (SMA)' : 'Minat Vokasi (SMK)';
    
    const questions = [
      // SMA IPA (0-4)
      'Saya lebih suka belajar teori di kelas',
      'Saya berencana kuliah S1 setelah lulus',
      'Saya suka membaca buku pelajaran tebal',
      'Saya tertarik pada ilmu sosial dan saintek',
      'Saya ingin jadi ilmuwan atau akademisi',
      // SMA IPS (5-9)
      'Saya suka pelajaran Sejarah atau Sosiologi',
      'Saya suka diskusi filosofis',
      'Saya ingin mendalami satu mata pelajaran secara luas',
      'Saya suka menganalisis masalah sosial',
      'Saya tertarik dengan ekonomi dan bisnis',
      // SMA Bahasa (10-14)
      'Saya tertarik sastra dan budaya',
      'Saya suka menulis esai panjang',
      'Saya senang mempelajari bahasa asing',
      'Saya ingin jadi dosen/guru',
      'Saya suka membaca karya sastra',
      // SMK Teknologi (15-19)
      'Saya suka membongkar pasang alat',
      'Saya tertarik pada keterampilan teknis spesifik',
      'Saya ingin jadi teknisi atau ahli madya',
      'Saya suka memperbaiki kerusakan alat',
      'Saya tertarik dengan mesin dan elektronika',
      // SMK TIK (20-24)
      'Saya senang belajar komputer dan teknologi',
      'Saya tertarik membuat aplikasi atau website',
      'Saya suka desain grafis dan multimedia',
      'Saya ingin jadi programmer atau IT specialist',
      'Saya suka mempelajari jaringan komputer',
      // SMK Bisnis (25-29)
      'Saya suka berjualan dan berbisnis',
      'Saya tertarik akuntansi dan administrasi',
      'Saya ingin bekerja di bidang pemasaran',
      'Saya suka mengorganisir kegiatan',
      'Saya ingin jadi pengusaha/profesional',
      // SMK Kesehatan (30-34)
      'Saya senang membantu orang yang sakit',
      'Saya tertarik dengan ilmu kesehatan',
      'Saya ingin jadi perawat atau tenaga medis',
      'Saya tidak takut melihat darah',
      'Saya peduli pada kesejahteraan masyarakat',
      // SMK Pariwisata (35-39)
      'Saya senang bertemu orang baru',
      'Saya tertarik dengan perhotelan dan kuliner',
      'Saya suka traveling dan wisata',
      'Saya ingin bekerja di hotel atau maskapai',
      'Saya tertarik dengan budaya berbagai daerah',
      // SMK Agribisnis (40-44)
      'Saya senang berkebun atau beternak',
      'Saya tertarik pertanian modern',
      'Saya suka bekerja di alam terbuka',
      'Saya ingin jadi petani modern atau agropreneur',
      'Saya tertarik perikanan atau kehutanan',
      // SMK Seni (45-49)
      'Saya senang menggambar atau melukis',
      'Saya tertarik desain dan fashion',
      'Saya suka musik, tari, atau seni pertunjukan',
      'Saya ingin jadi desainer atau seniman',
      'Saya tertarik fotografi atau videografi'
    ];
    ...
    return {
      ...
      categoryId: 'belajar',
      jurusan: jurusan,
      text: questions[i] || 'Pertanyaan preferensi SMA/SMK',
  ...
  riasec: Array.from({ length: 42 }, (_, i) => {
    // 6 Dimensions, 7 questions each
    const dimensions = ['R', 'I', 'A', 'S', 'E', 'C'];
    const dimIndex = Math.floor(i / 7);
    const dim = dimensions[dimIndex];

    // Questions pool
    const riasecQuestions = [
      // Realistic (0-6)
      'Saya suka memperbaiki alat elektronik atau mesin yang rusak',
      'Saya suka bekerja dengan kayu (pertukangan)',
      'Saya bisa mengoperasikan kendaraan atau alat berat',
      'Saya suka merakit komputer atau peralatan mekanik',
      'Saya lebih suka bekerja di luar ruangan (lapangan)',
      'Saya suka kegiatan fisik atau olahraga',
      'Saya praktis dan suka melihat hasil nyata dari kerja saya',

      // Investigative (7-13)
      'Saya suka memecahkan teka-teki logika atau matematika',
      'Saya suka membaca artikel sains atau teknologi',
      'Saya tertarik meneliti penyebab suatu masalah',
      'Saya suka menganalisis data atau grafik',
      'Saya suka melakukan eksperimen ilmiah',
      'Saya kritis dan suka bertanya "mengapa"',
      'Saya lebih suka bekerja sendiri untuk memikirkan ide kompleks',

      // Artistic (14-20)
      'Saya suka menggambar, melukis, atau membuat sketsa',
      'Saya bisa memainkan alat musik atau bernyanyi',
      'Saya suka menulis puisi, cerpen, atau blog kreatif',
      'Saya suka mendesain poster atau pakaian',
      'Saya imajinatif dan sering punya ide unik',
      'Saya tidak suka aturan yang kaku, saya suka kebebasan',
      'Saya sensitif terhadap keindahan seni dan alam',

      // Social (21-27)
      'Saya suka membantu teman yang sedang kesulitan',
      'Saya suka mengajar atau menjelaskan materi ke orang lain',
      'Saya mudah bergaul dan punya banyak teman',
      'Saya suka kerja kelompok dibanding kerja sendiri',
      'Saya peduli dengan perasaan orang lain (empatik)',
      'Saya suka kegiatan sukarelawan atau amal',
      'Saya pendengar yang baik bagi teman yang curhat',

      // Enterprising (28-34)
      'Saya suka memimpin kelompok atau menjadi ketua kelas',
      'Saya berani berbicara di depan umum',
      'Saya suka meyakinkan orang lain agar setuju dengan saya',
      'Saya ambisius dan ingin sukses secara finansial',
      'Saya suka memulai proyek atau usaha baru',
      'Saya kompetitif dan suka tantangan',
      'Saya percaya diri dan energik',

      // Conventional (35-41)
      'Saya suka kerapian dan keteraturan',
      'Saya suka bekerja dengan angka dan hitungan detail',
      'Saya suka mengikuti jadwal dan rencana yang pasti',
      'Saya teliti dalam mengecek kesalahan penulisan',
      'Saya suka mengorganisir file atau dokumen',
      'Saya taat pada aturan dan prosedur sekolah',
      'Saya lebih suka tugas yang jelas instruksinya'
    ];

    return {
      id: `riasec_${i + 1}`,
      category: dim, // Stored as category/dimension
      categoryId: 'karier',
      text: riasecQuestions[i],
      // Options will be handled in the component (Likert scale)
      options: ['Sangat Tidak Suka', 'Tidak Suka', 'Netral', 'Suka', 'Sangat Suka']
    };
  }),
