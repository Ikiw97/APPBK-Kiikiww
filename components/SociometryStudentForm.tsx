            ...
            <div className="max-w-xl mx-auto py-12 animate-in slide-in-from-bottom-4 duration-500">
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center">
                    ...
                    <div className="text-left mb-6">
                        ...
                        <select
                            className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-primary-500 bg-white"
                    ...
                    <button
                        ...
                        disabled={!mySelf}
                        className="w-full py-3 bg-primary-600 text-white rounded-lg font-bold hover:bg-primary-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
                    >
    ...
    return (
        <div className="max-w-4xl mx-auto animate-in slide-in-from-bottom-4 duration-500 pb-20">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                <div className="p-6 md:p-8 border-b border-slate-100 bg-gradient-to-r from-primary-50 to-indigo-50">
                    ...
                    {session.questions.map((q, qIdx) => (
                        <div key={qIdx} className="space-y-6">
                            <h3 className="text-lg font-bold text-slate-800 flex gap-4">
                                <span className="flex-shrink-0 w-8 h-8 bg-primary-600 text-white rounded-lg flex items-center justify-center text-lg font-bold">
                                    {qIdx + 1}
                                </span>
                                {q}
                            </h3>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 ml-12">
                                {[0, 1, 2].map((slotIdx) => (
                                    <div key={slotIdx} className="space-y-2">
                                        ...
                                        <select
                                            className="w-full px-3 py-2.5 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-primary-500 bg-white text-sm"
                ...
                <div className="p-6 bg-slate-50 border-t border-slate-200 flex justify-end">
                    <button
                        ...
                        disabled={submitting}
                        className="flex items-center gap-2 px-8 py-3 bg-primary-600 text-white rounded-xl font-bold hover:bg-primary-700 hover:shadow-lg transition-all transform hover:-translate-y-1 active:translate-y-0 disabled:opacity-50 disabled:transform-none"
                    >
                        {submitting ? 'Mengirim...' : (
                            <>
