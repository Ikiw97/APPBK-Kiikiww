            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2 bg-slate-100 p-1 rounded-lg">
                    <button
                        ...
                        className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium transition-all ${viewMode === 'ranking' ? 'bg-white text-primary-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium transition-all ${viewMode === 'matrix' ? 'bg-white text-primary-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'
                            }`}
                    >
                                ...
                                {analysis?.rankedStudents.map((item: any, idx: number) => (
                                    <div key={idx} className="p-4 flex items-center gap-4 hover:bg-slate-50 transition-colors">
                                        ...
                                        <div className="text-right flex-shrink-0">
                                            <span className="block text-lg font-bold text-primary-600">{item.count}</span>
