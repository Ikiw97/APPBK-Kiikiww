...
import { ChevronRight, Brain, Heart, Users, BookMarked, Zap, TrendingUp, ClipboardList, Sparkles, ArrowRight } from 'lucide-react';
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="inline-flex items-center gap-2 bg-indigo-50 border border-indigo-100 rounded-full px-4 py-1.5 mb-5">
                ...
                <span className="text-xs font-bold text-indigo-700 uppercase tracking-widest">Bank Instrumen</span>
              </div>
          ...
          availableAssessments.map((assessment, index) => {
            ...
            return (
              <button
                ...
                className="group relative bg-white rounded-2xl border border-slate-100 border-t-transparent overflow-hidden text-left transition-all duration-300 hover:shadow-xl hover:shadow-slate-200/50 hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-blue-500/50 block w-full p-0"
