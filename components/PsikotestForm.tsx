      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        {!showResults ? (
          ...
          <div className="space-y-6">
            ...
            {/* Recommendations */}
            <div className="card p-6 bg-gradient-to-r from-primary-50 to-purple-50 border-2 border-primary-200">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className="flex-1 py-3 px-4 bg-gradient-to-r from-primary-500 to-purple-500 text-white rounded-lg font-medium hover:shadow-lg transition-all flex items-center justify-center gap-2"
              >
                <Download size={20} />
                Unduh Hasil
              </button>
