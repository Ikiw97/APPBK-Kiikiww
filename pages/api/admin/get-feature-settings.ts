    ...
    if (data && data.settings) {
      ...
      const mergedSettings: FeatureSettings = {
        assessments: {
          ...
          riasec: data.settings.assessments?.riasec ?? DEFAULT_SETTINGS.assessments.riasec,
          bullying: data.settings.assessments?.bullying ?? DEFAULT_SETTINGS.assessments.bullying,
        ...
        system: {
          ...
          themeColor: data.settings.system?.themeColor ?? DEFAULT_SETTINGS.system.themeColor,
        },
        studentManagement: {
        ...
        services: {
          counseling_chat: data.settings.services?.counseling_chat ?? DEFAULT_SETTINGS.services.counseling_chat,
        },
      };

      console.log('✅ [get-feature-settings] Settings fetched successfully');
